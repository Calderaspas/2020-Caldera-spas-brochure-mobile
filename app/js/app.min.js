! function (e, t) {
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            setTimeout(function () {
                ...
                e("#getBrochure").attr("type", "button"), e("#getBrochure").on("click tap", function () {
                    axios({
                       ...
                       if ((navigator.userAgent.match('CriOS')) || (navigator.userAgent.match('OPiOS')) || (navigator.userAgent.match('EdgiOS'))) {
                            window.open('./caldera-spas-2020-brochure.pdf');
                        }   
                        var t = window.URL.createObjectURL(new Blob([e.data])),
                            s = document.createElement("a");
                        s.href = t, s.target = "_blank", s.setAttribute("download", "Caldera Spas Brochure | 2020.pdf"), document.body.appendChild(s), s.click(), s.tap()
                    }, function (e) {
                        var t = new Date(2018, 11, 24, 10, 33);
                        console.log(e + t)
                    })
                })
            }), setTimeout(function () {
            ...
            d.s.dynamic ? (d.s.dynamicEl[t].poster && (c = !0, l = d.s.dynamicEl[t].poster), u = d.s.dynamicEl[t].html, a = d.s.dynamicEl[t].src, d.s.dynamicEl[t].responsive && h(d.s.dynamicEl[t].responsive.split(",")), r = d.s.dynamicEl[t].srcset, n = d.s.dynamicEl[t].sizes) : (d.$items.eq(t).attr("data-poster") && (c = !0, l = d.$items.eq(t).attr("data-poster")), u = d.$items.eq(t).attr("data-html"), a = d.$items.eq(t).attr("href") || d.$items.eq(t).attr("data-src"), d.$items.eq(t).attr("data-responsive") && h(d.$items.eq(t).attr("data-responsive").split(",")), r = d.$items.eq(t).attr("data-srcset"), n = d.$items.eq(t).attr("data-sizes"));
            var g = !1;
            d.s.dynamic ? d.s.dynamicEl[t].iframe && (g = !0) : "true" === d.$items.eq(t).attr("data-iframe") && (g = !0);
            var m = d.isVideo(a, t);
            if (!d.$slide.eq(t).hasClass("lg-loaded")) {
                if (g) d.$slide.eq(t).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + d.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>');
                else if (c) {
                    var p = "";
                    p = m && m.youtube ? "lg-has-youtube" : m && m.vimeo ? "lg-has-vimeo" : "lg-has-html5", d.$slide.eq(t).prepend('<div class="lg-video-cont ' + p + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + l + '" /></div></div>')
                } else m ? (d.$slide.eq(t).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), d.$el.trigger("hasVideo.lg", [t, a, u])) : d.$slide.eq(t).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + a + '" /></div>');
                if (d.$el.trigger("onAferAppendSlide.lg", [t]), i = d.$slide.eq(t).find(".lg-object"), n && i.attr("sizes", n), r) {
                    i.attr("srcset", r);
                    try {
                        picturefill({
                            elements: [i[0]]
            ...
            }), m && m.html5 && !c && d.$slide.eq(t).addClass("lg-complete"), !0 === s && (d.$slide.eq(t).hasClass("lg-complete") ? d.preload(t) : d.$slide.eq(t).find(".lg-object").on("load.lg error.lg", function () {
                d.preload(t)
            }))
...
function (e, t) {
    ...
    ! function () {
        ...
        function o(t, s, o) {
            ...
            d && e(d).attr("src", e(d).attr("src").replace("&autoplay", "&noplay")), i = a.core.s.dynamic ? a.core.s.dynamicEl[o].src : a.core.$items.eq(o).attr("href") || a.core.$items.eq(o).attr("data-src");
        ...
        a.prototype.init = function () {
            ...
            var l = "",
                r = 1,
                n = "",
                u = this.core.isVideo(t, i) || {};
            if (o && (r = this.videoLoaded ? 0 : this.core.s.autoplayFirstVideo ? 1 : 0), u.youtube) n = "?wmode=opaque&autoplay=" + r + "&enablejsapi=1", this.core.s.youtubePlayerParams && (n = n + "&" + e.param(this.core.s.youtubePlayerParams)), l = '<iframe class="lg-video-object lg-youtube ' + s + '" width="560" height="315" src="//www.youtube.com/embed/' + u.youtube[1] + n + '" frameborder="0" allowfullscreen></iframe>';
            else if (u.vimeo) n = "?autoplay=" + r + "&api=1", this.core.s.vimeoPlayerParams && (n = n + "&" + e.param(this.core.s.vimeoPlayerParams)), l = '<iframe class="lg-video-object lg-vimeo ' + s + '" width="560" height="315"  src="//player.vimeo.com/video/' + u.vimeo[1] + n + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
            else if (u.dailymotion) n = "?wmode=opaque&autoplay=" + r + "&api=postMessage", this.core.s.dailymotionPlayerParams && (n = n + "&" + e.param(this.core.s.dailymotionPlayerParams)), l = '<iframe class="lg-video-object lg-dailymotion ' + s + '" width="560" height="315" src="//www.dailymotion.com/embed/video/' + u.dailymotion[1] + n + '" frameborder="0" allowfullscreen></iframe>';
            else if (u.html5) {
                var d = a.substring(0, 1);
                "." !== d && "#" !== d || (a = e(a).html()), l = a
            } else u.vk && (n = "&autoplay=" + r, this.core.s.vkPlayerParams && (n = n + "&" + e.param(this.core.s.vkPlayerParams)), l = '<iframe class="lg-video-object lg-vk ' + s + '" width="560" height="315" src="//vk.com/video_ext.php?' + u.vk[1] + n + '" frameborder="0" allowfullscreen></iframe>');
            return l
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            var o = 1,
                ...
                l = function (s, i, l, r) {
                    var n, u = i.prop("offsetWidth");
                    n = t.core.s.dynamic ? t.core.s.dynamicEl[l].width || i[0].naturalWidth || u : t.core.$items.eq(l).attr("data-width") || i[0].naturalWidth || u, t.core.$outer.hasClass("lg-zoomed") ? o = 1 : n > u && (o = n / u || 2), r ? (t.pageX = e(window).width() / 2, t.pageY = e(window).height() / 2 + e(window).scrollTop()) : (t.pageX = s.pageX || s.originalEvent.targetTouches[0].pageX, t.pageY = s.pageY || s.originalEvent.targetTouches[0].pageY), a(), setTimeout(function () {
            ...
            e.core.$slide.on("touchstart.lg", function (s) {
                ...
                if (e.core.$outer.hasClass("lg-zoomed")) {
                    var r, n, u = e.core.$slide.eq(e.core.index).find(".lg-img-wrap");
                    l.preventDefault(), o = !0, s = {
                        x: l.originalEvent.targetTouches[0].pageX,
                        y: l.originalEvent.targetTouches[0].pageY
                    }, e.core.$outer.addClass("lg-zoom-dragging"), n = a ? -Math.abs(u.attr("data-y")) + (s.y - t.y) : -Math.abs(u.attr("data-y")), r = i ? -Math.abs(u.attr("data-x")) + (s.x - t.x) : -Math.abs(u.attr("data-x")), (Math.abs(s.x - t.x) > 15 || Math.abs(s.y - t.y) > 15) && (e.core.s.useLeftForZoom ? u.css({
                        left: r + "px",
                        top: n + "px"
                    }) : u.css("transform", "translate3d(" + r + "px, " + n + "px, 0)"))
                }
            ...
            t.core.$slide.on("mousedown.lg.zoom", function (o) {
                ...
                if (i) {
                    var n, u, d = t.core.$slide.eq(t.core.index).find(".lg-img-wrap");
                    a = !0, o = {
                        x: e.pageX,
                        y: e.pageY
                    }, t.core.$outer.addClass("lg-zoom-dragging"), u = r ? -Math.abs(d.attr("data-y")) + (o.y - s.y) : -Math.abs(d.attr("data-y")), n = l ? -Math.abs(d.attr("data-x")) + (o.x - s.x) : -Math.abs(d.attr("data-x")), t.core.s.useLeftForZoom ? d.css({
                        left: n + "px",
                        top: u + "px"
                    }) : d.css("transform", "translate3d(" + n + "px, " + u + "px, 0)")
                }
            ...
            var i = this,
                ...
                u = (i.core.$outer.find(".lg").height() - l.prop("offsetHeight")) / 2,
                d = Math.abs(l.prop("offsetHeight") * Math.abs(l.attr("data-scale")) - i.core.$outer.find(".lg").height() + u),
            ...
            (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) && (o && (n <= -d ? n = -d : n >= -u && (n = -u)), s && (r <= -h ? r = -h : r >= -c && (r = -c)), o ? a.attr("data-y", Math.abs(n)) : n = -Math.abs(a.attr("data-y")), s ? a.attr("data-x", Math.abs(r)) : r = -Math.abs(a.attr("data-x")), i.core.s.useLeftForZoom ? a.css({
                left: r + "px",
                top: n + "px"
...
function (e, t) {
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            s += t.core.s.menuLinkOne ? '<li><a id="menu-link-one" alt="' + this.core.s.menuLinkOneText + '" title="' + this.core.s.menuLinkOneText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkOneText + "</span></a></li>" : "", s += t.core.s.menuLinkTwo ? '<li><a id="menu-link-two" alt="' + this.core.s.menuLinkTwoText + '" title="' + this.core.s.menuLinkTwoText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkTwoText + "</span></a></li>" : "", s += t.core.s.menuLinkThree ? '<li><a id="menu-link-three" alt="' + this.core.s.menuLinkThreeText + '" title="' + this.core.s.menuLinkThreeText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkThreeText + "</span></a></li>" : "", s += t.core.s.menuLinkFour ? '<li><a id="menu-link-four" alt="' + this.core.s.menuLinkFourText + '" title="' + this.core.s.menuLinkFourText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkFourText + "</span></a></li>" : "", s += t.core.s.menuLinkFive ? '<li><a id="menu-link-five" alt="' + this.core.s.menuLinkFiveText + '" title="' + this.core.s.menuLinkFiveText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkFiveText + "</span></a></li>" : "", s += t.core.s.menuLinkSix ? '<li><a id="menu-link-six" alt="' + this.core.s.menuLinkSixText + '" title="' + this.core.s.menuLinkSixText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkSixText + "</span></a></li>" : "", s += "</ul></span>", this.core.$outer.find(".lg-toolbar").prepend(s), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'), e("#lg-share").on("click.lg", function () {
