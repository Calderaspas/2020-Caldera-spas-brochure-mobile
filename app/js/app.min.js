! function (e, t) {
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            setTimeout(function() {
                e('.caldera-link').attr('href', 'https://calderaspas.com').attr('target','_blank')
            })
            setTimeout(function () {

                e('#getBrochure').attr('type', 'button').attr('download', '2020_Caldera_Spas_Brochure.pdf');
                e('#getBrochure').on('click', function () {
                    
                    e.ajax({
                        url: 'https://calderaspas.github.io/2020-Caldera-spas-brochure-mobile/caldera-spas-2020-brochure.pdf',
                        method: 'GET',
                        xhrFields: {
                            responseType: 'blob',
                        },
                        
                        success: function (broch) {
                            var a = document.createElement('a');
                            var url = window.URL.createObjectURL(broch);
                            a.href = url;
                            a.download = '2020_Caldera_Spas_Brochure.pdf';
                            a.target = '_blank';
                            document.body.append(a);
                            a.click();
                            a.remove();
                            window.URL.revokeObjectURL(url), 300;
                            alert("Your Caldera Spas Brochure has downloaded")
                        }
                    });
                });
            }), setTimeout(function () {
