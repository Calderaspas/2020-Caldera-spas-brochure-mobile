! function (e, t) {
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            if (this.s.controls && this.$items.length > 1 && (o = '<div class="lg-actions"><button class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (l = '<div class="lg-sub-html"></div>'), t = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + s + '</div><a href="https://calderaspas.com target="_blank"><span class="lg-icon" id="lg-link-home"></span><div class="lg-toolbar lg-group"><a class="lg-icon pdf"></a></div>' + o + l + "</div></div>", e("body").append(t), this.$outer = e(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), i.setTop(), e(window).on("resize.lg orientationchange.lg", function () {
                    setTimeout(function () {
                        i.setTop()
                    }, 100)
            ...
            setTimeout(function () {
                e(".pdf").attr({
                    "href": "caldera-spas-hot-tub-brochure-2020-rev-a-email.pdf",
                    "download": "caldera-spas-hot-tub-brochure-2020-rev-a-email.pdf"
                })
            })
            setTimeout(function () {
...
function (e, t) {
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            t.core.s.actualSize && (s += '<span id="lg-actual-size" class="lg-icon"></span>'), t.core.s.useLeftForZoom ? t.core.$outer.addClass("lg-use-left-for-zoom") : t.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(s), t.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (s, o, a) {
                ...
                s += "</ul></span>", this.core.$outer.find(".lg-toolbar").prepend(s), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'), e("#lg-share").on("click.lg", function () {
                    ...
                    setTimeout(function () {
                        e("#lg-jump-caldera-difference").attr("href", "#lg=1&slide=5"),
                            ...
                            e("#lg-jump-downloadPdf").attr("href", ".Caldera-spas-2020-brochure.pdf").attr("download", ".Caldera-spas-2020-brochure.pdf"),
