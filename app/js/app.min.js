! function (e, t) {
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            setTimeout(function () {
                e(".pdf").attr({
                    href: "https://calderaspas.github.io/2020-Caldera-spas-brochure-desktop/Caldera-spas-2020-brochure.pdf",
                    download: "https://calderaspas.github.io/2020-Caldera-spas-brochure-desktop/Caldera-spas-2020-brochure.pdf",
                    target: "_blank"
                }), e(".caldera-link").attr({
            ...
            c.s.dynamic ? (c.s.dynamicEl[t].poster && (u = !0, l = c.s.dynamicEl[t].poster), d = c.s.dynamicEl[t].html, a = c.s.dynamicEl[t].src, c.s.dynamicEl[t].responsive && h(c.s.dynamicEl[t].responsive.split(",")), r = c.s.dynamicEl[t].srcset, n = c.s.dynamicEl[t].sizes) : (c.$items.eq(t).attr("data-poster") && (u = !0, l = c.$items.eq(t).attr("data-poster")), d = c.$items.eq(t).attr("data-html"), a = c.$items.eq(t).attr("href") || c.$items.eq(t).attr("data-src"), c.$items.eq(t).attr("data-responsive") && h(c.$items.eq(t).attr("data-responsive").split(",")), r = c.$items.eq(t).attr("data-srcset"), n = c.$items.eq(t).attr("data-sizes"));
            var g = !1;
            c.s.dynamic ? c.s.dynamicEl[t].iframe && (g = !0) : "true" === c.$items.eq(t).attr("data-iframe") && (g = !0);
            var m = c.isVideo(a, t);
            if (!c.$slide.eq(t).hasClass("lg-loaded")) {
                if (g) c.$slide.eq(t).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>');
                else if (u) {
                    var p = "";
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            var i = this,
                ...
                h = Math.abs(l.prop("offsetWidth") * Math.abs(l.attr("data-scale")) - i.core.$outer.find(".lg").width() + u);
            (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) && (o && (n <= -c ? n = -c : n >= -d && (n = -d)), s && (r <= -h ? r = -h : r >= -u && (r = -u)), o ? a.attr("data-y", Math.abs(n)) : n = -Math.abs(a.attr("data-y")), s ? a.attr("data-x", Math.abs(r)) : r = -Math.abs(a.attr("data-x")), i.core.s.useLeftForZoom ? a.css({
                left: r + "px",
                top: n + "px"
