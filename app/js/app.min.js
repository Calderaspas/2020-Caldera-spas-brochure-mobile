! function (e, t) {
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            if (this.s.controls && this.$items.length > 1 && (o = '<div class="lg-actions"><button title="View Previous Page" class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button title="View Next Page" class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (l = '<div class="lg-sub-html"></div>'), t = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + s + '</div><a href="https://calderaspas.com target="_blank"><span class="lg-icon" id="lg-link-home"></span><div class="lg-toolbar lg-group"><a href="" download="https://caldera-wordpress.s3.amazonaws.com/documents/Brochure/caldera-spas-hot-tub-brochure-2020-rev-a-email.pdf"><span class="lg-icon dnld-pdf-icon"></span><a/></div>' + o + l + "</div></div>", e("body").append(t), this.$outer = e(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), i.setTop(), e(window).on("resize.lg orientationchange.lg", function () {
                    setTimeout(function () {
                        i.setTop()
                    }, 100)
...
function (e, t) {
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            s += t.core.s.theDifference ? '<li><a id="lg-jump-caldera-difference"><span class="lg-dropdown-text">' + this.core.s.theCalderaDifferenceText + "</span></a></li>" : "", 
            s += t.core.s.perfectFit ? '<li><a id="lg-jump-perfect-fit"><span class="lg-dropdown-text">' + this.core.s.discoverYourPerfectFitText + "</span></a></li>" : "", 
            
            s += t.core.s.specifications ? '<li><a id="lg-jump-detailed-specifications"><span class="lg-dropdown-text">' + this.core.s.detailedSpecificationsText + "</span></a></li>" : "", 
            
            s += t.core.s.essentials ? '<li><a id="lg-jump-essentials-and-accessories"><span class="lg-dropdown-text">' + this.core.s.essentialsAndAccessoriesText + "</span></a></li>" : "", 
            
            s += t.core.s.warranty ? '<li><a id="lg-jump-warranty"><span class="lg-dropdown-text">' + this.core.s.warrantyText + "</span></a></li>" : "", 
            
            s += t.core.s.downloadPdf ? '<li><a id="lg-jump-downloadPdf"><span class="lg-dropdown-text">' + this.core.s.downloadPdfText + "</span></a></li>" : "", 

            s += t.core.s.calderaSpasLink ? '<li><a id="lg-jump-caldera-home-page"><span class="lg-dropdown-text">' + this.core.s.calderaSpasLinkText + "</span></a></li>" : "", 
