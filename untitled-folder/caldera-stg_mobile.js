            ...
            setTimeout((function() {
                ...
                e("#getBrochure").attr("type", "button"), e("#getBrochure").on("click tap", (function() {
                    axios({
                        ...
                        if (1 == FxiOS) window.open("./caldera-spas-2020-brochure.pdf");
                        else if (1 == CriOS) window.open("./caldera-spas-2020-brochure.pdf");
                        else if (1 == OpiOS) window.open("./caldera-spas-2020-brochure.pdf");
                        else if (1 == EdgiOS) window.open("./caldera-spas-2020-brochure.pdf");
                        else {
                            var url = window.URL.createObjectURL(new Blob([response.data], {
                                    type: "application/pdf"
                                })),
                                link = document.createElement("a");
                            link.href = url, link.target = "_blank", link.setAttribute("download", "Caldera Spas Brochure | 2020.pdf"), document.body.appendChild(link), link.click(), link.tap(), setTimeout((function() {
