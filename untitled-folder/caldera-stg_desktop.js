    ...
    ! function() {
        ...
        t.prototype.init = function() {
            ...
            var t, s = "",
                ...
                a = "",
                l = this;
            for (e("body").append('<div class="lg-backdrop"></div>'), e(".lg-backdrop").css("transition-duration", this.s.backdropDuration + "ms"), i = 0; i < this.$items.length; i++) 
            ...
            setTimeout((function() {
                ...
                e("#getBrochure").attr("type", "button"), e("#getBrochure").on("click tap", (function() {
                    axios({
                        ...
                        (navigator.userAgent.match("CriOS") || navigator.userAgent.match("Opera Mini") || navigator.userAgent.match("EdgiOS")) && window.open("./wp-content/themes/prelude-child/assets/2020-brochure-desktop/Caldera-spas-2020-brochure.pdf");
