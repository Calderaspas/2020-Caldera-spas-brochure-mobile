    ...
    ! function() {
        ...
        var s = {
            ...
            dynamicEl: [{
                ...
                src: "./app/image-assets/svg-layers/page-01.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-02-03.jpg",
                src: "./app/image-assets/svg-layers/pages-02-03.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-04-05.jpg",
                src: "./app/image-assets/svg-layers/pages-04-05.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-06-07.jpg",
                src: "./app/image-assets/svg-layers/pages-06-07.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-08-09.jpg",
                src: "./app/image-assets/svg-layers/pages-08-09.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-10-11.jpg",
                src: "./app/image-assets/svg-layers/pages-10-11.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-12-13.jpg",
                src: "./app/image-assets/svg-layers/pages-12-13.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-14-15.jpg",
                src: "./app/image-assets/svg-layers/pages-14-15.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-16-17.jpg",
                src: "./app/image-assets/svg-layers/pages-16-17.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-18-19.jpg",
                src: "./app/image-assets/svg-layers/pages-18-19.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-20-21.jpg",
                src: "./app/image-assets/svg-layers/pages-20-21.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-22-23.jpg",
                src: "./app/image-assets/svg-layers/pages-22-23.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-24-25.jpg",
                src: "./app/image-assets/svg-layers/pages-24-25.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-26-27.jpg",
                src: "./app/image-assets/svg-layers/pages-26-27.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-28-29.jpg",
                src: "./app/image-assets/svg-layers/pages-28-29.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-30-31.jpg",
                src: "./app/image-assets/svg-layers/pages-30-31.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-32-33.jpg",
                src: "./app/image-assets/svg-layers/pages-32-33.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-34-35.jpg",
                src: "./app/image-assets/svg-layers/pages-34-35.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-36-37.jpg",
                src: "./app/image-assets/svg-layers/pages-36-37.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-38-39.jpg",
                src: "./app/image-assets/svg-layers/pages-38-39.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-40-41.jpg",
                src: "./app/image-assets/svg-layers/pages-40-41.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-42-43.jpg",
                src: "./app/image-assets/svg-layers/pages-42-43.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-44-45.jpg",
                src: "./app/image-assets/svg-layers/pages-44-45.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-46-47.jpg",
                src: "./app/image-assets/svg-layers/pages-46-47.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-48-49.jpg",
                src: "./app/image-assets/svg-layers/pages-48-49.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-50-51.jpg",
                src: "./app/image-assets/svg-layers/pages-50-51.svg"
            }, {
                thumb: "./app/image-assets/thumbnails/thumb-52.jpg",
                src: "./app/image-assets/svg-layers/page-52.svg"
            }],
            hash: !0,
            galleryId: 1,
            pager: !0,
        ...
        t.prototype.init = function() {
            ...
            if (this.s.controls && this.$items.length > 1 && (o = '<div class="lg-actions"><button class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (a = '<div class="lg-sub-html"></div>'), t = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + s + '</div><a class="caldera-link"><span class="lg-icon" id="lg-link-home"></span></a><div class="lg-toolbar lg-group"><button class="lg-icon pdf" id="getBrochure"></button></div>' + o + a + "</div></div>", e("body").append(t), this.$outer = e(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), l.setTop(), e(window).on("resize.lg orientationchange.lg", (function() {
                    setTimeout((function() {
                        l.setTop()
                    }), 100)
            ...
            setTimeout((function() {
                ...
                e("#getBrochure").attr("type", "button"), e("#getBrochure").on("click tap", (function() {
                    axios({
                        ...
                        (navigator.userAgent.match("CriOS") || navigator.userAgent.match("Opera Mini") || navigator.userAgent.match("EdgiOS")) && window.open("./Caldera-spas-2020-brochure.pdf");
                        var url = window.URL.createObjectURL(new Blob([response.data])),
                            link = document.createElement("a");
                        link.href = url, link.target = "_blank", link.setAttribute("download", "Caldera Spas Brochure | 2020.pdf"), document.body.appendChild(link), link.click(), link.tap(), link.remove()
                    }), (function(error) {
